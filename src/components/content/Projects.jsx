...
export default function Projects() {
  return (
      <div className="grid gap-2 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
        ...
        <ProjectCard title="Text Adventure" description="Choose-your-own-adventure game creator" links={{"github": "https://github.com/bean-frog/pi-neopixel-2"}} languages={["Rust", "Javascript"]} />
        ...
        <ProjectCard title="Mimir" description="Search for papers across a few different journals" links={{"github": "https://github.com/bean-frog/mimir"}} languages={["Javascript"]} />
